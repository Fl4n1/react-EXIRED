...
const Profile = () => {
    ...
    const changeUser = (data) => {
        ...
        axios.patch(`//shop-server-alpha.vercel.app/users/${user.id}`, data)
            .then(({data}) => {
                setUser(data);
    ...
    const changePassword = (data) => {
        axios.patch(`//shop-server-alpha.vercel.app/users/${user.id}`, {password: data.password})
                                            ...
                                            <ul className='profile__orders-list'>
                                                {
                                                    item.clothes.map(el => (
                                                        <li className='profile__orders-item ' key={el.id}>
                                                            <img className='profile__orders-image' src={`../${el.image.black}`} alt=""/>
